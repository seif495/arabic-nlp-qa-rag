...
## MS2-TRAIN-01 [DONE]: Training Utilities (Optimizer, LR Schedules, Loss, Gradient Clipping, Loop)
...
- Dependencies: `MS2-DATA-01` [DONE], `MS2-MODEL-A-03`, `MS2-MODEL-B-03`, `MS2-TRAIN-01` [DONE], `MS2-EVAL-01`. Compute-bound, not code-bound; story points reflect orchestration cost, not implementation.
- Story points: 3.
...
- Dependencies: `MS2-MODEL-A-03`, `MS2-MODEL-B-03`, `MS2-TRAIN-01` [DONE], `MS2-TRAIN-02` (for compute-budget calibration). Compute-heavy.
- Story points: 4.
...
5. **Parallel batch (a)**:
   - `MS2-TRAIN-01` [DONE] Training utilities
   - `MS2-EVAL-01` Metrics implementation and Arabic post-normalization
